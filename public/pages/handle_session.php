...
<form action="" method="POST"
    ...
    <div class="relative inline-block">
        ...
        <div id="searchResults"
            class="absolute bg-white dark:bg-[var(--color-fill-secondary)] top-full inset-x-0 border border-zinc-600 shadow z-10 rounded-sm divide-y divide-y-2 divide-gray-200 dark:divide-zinc-600 cursor-pointer *:odd:bg-slate-200 *:even:bg-slate-50 *:dark:odd:bg-[var(--color-fill)] *:dark:even:bg-[var(--color-fill-secondary)] *:px-2 *:py-1 *:first:rounded-t-sm *:last:rounded-b-sm hidden">
        </div>
    </div>
